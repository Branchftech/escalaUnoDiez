@props(['title', 'name','modal'=>'showModal','positionTop' => 'top-2','maxWidth' => 'modal-lg'])
<div x-data="{ show: @entangle($modal), name: '{{ $name  }}' }"
    ...
    <div class=" p-4 card rounded-lg shadow-lg {{ $positionTop }}"style="position: relative;margin: auto; border-radius: 0.5rem;{{$maxWidth? 'max-width: 42rem;':''}}">
