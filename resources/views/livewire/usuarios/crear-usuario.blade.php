<div>
    <div class="mb-3">
        <button class="btn btn-warning" style="background-color: #50a803; border-color: #50a803; color:white" x-data x-on:click="$dispatch('open-modal', {name: 'Crear-Usuario'})">
            Agregar
        </button>
    </div>

    <x-modal-default title="Crear Usuario" name="Crear-Usuario" positionTop="top-10">
        <x-slot:body>
            <div class="p-4">
