...
@if ($component->filtersAreEnabled() && $component->filterPillsAreEnabled() && $component->hasAppliedVisibleFiltersForPills())
    <div>
        <div @class([
            ...
            <small @class([
                'text-gray-700' => $component->isTailwind(),
            ...
            @foreach($component->getAppliedFiltersWithValues() as $filterSelectName => $value)
                ...
                @else
                    <span
                        ...
                        @class([
                            'inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium leading-4 bg-indigo-100 text-indigo-800 capitalize' => $component->isTailwind(),
