        ...
        <button
            {{ 
                ...
                ->class([
                    ...
                    'border-gray-300 bg-white text-gray-700 hover:bg-gray-50 focus:border-indigo-300 focus:ring-indigo-200' => $component->isTailwind()  && $this->getBulkActionsButtonAttributes['default-colors'] ?? true,
            ...
            >
                <div
                    {{ 
                        ...
                        ->class([
                            'bg-white' => $component->isTailwind() && $this->getBulkActionsMenuAttributes['default-colors'] ?? true,
                        ...
                        @foreach ($component->getBulkActions() as $action => $title)
                            <button
                                ...
                                {{ 
                                    ...
                                    ->class([
                                        'text-gray-700 hover:bg-gray-100 hover:text-gray-900 focus:bg-gray-100 focus:text-gray-900' => $component->isTailwind() && $this->getBulkActionsMenuItemAttributes['default-colors'] ?? true,
