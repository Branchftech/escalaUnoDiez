    ...
    @class([
        ...
        <input
            ...
            {{ 
                ...
                ->class([
                    'block w-full border-gray-300 rounded-md shadow-sm transition duration-150 ease-in-out sm:text-sm sm:leading-5 rounded-none rounded-md focus:ring-0 focus:border-gray-300' => $component->isTailwind() && $component->hasSearch() && $component->getSearchFieldAttributes()['default'] ?? true,
        ...
        <div  @class([
                ...
                <div
                    ...
                    @class([
                            'btn btn-outline-secondary d-inline-flex h-100 align-items-center ms-3' => $component->isBootstrap(),
                            'inline-flex h-full items-center p-2 text-gray-500 bg-gray-50 rounded-r-md border border-l-0 border-gray-300 cursor-pointer sm:text-sm' => $component->isTailwind(),
                        ])
                >
